                    ...
                    <div class="p-3 border border-3 border-primary">
                        <div class="row">
                            ...
                            <div class="col-sm-4 mb-2">
                                ...
                                <input type="text" id="precio_venta" name="arrayprecioventa[]" class="form-control"
                                    step="0.1" readonly>
                            </div>
...
@push('js')
    ...
    <script>
        ...
        document.getElementById('precio_compra').addEventListener('input', function() {
            var precioCompra = parseFloat(this.value);
            var precioVenta = precioCompra + (precioCompra * 0.3);
